    ...
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form wire:submit.prevent="createNewMessage" action="#" class="space-y-8">
            ...
            <div>
                ...
                <input wire:model="contactForm.subject" type="text" id="subject"
            ...
            <div class="sm:col-span-2">
                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your
                    message</label>
                <textarea wire:model="contactForm.message" id="message" rows="6"
            ...
            <button type="submit"
                class="py-3 px-5 text-sm cursor-pointer font-medium text-center text-white rounded-lg bg-blue-700 sm:w-fit hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send
                message</button>
        </form>
    </div>
</section>
