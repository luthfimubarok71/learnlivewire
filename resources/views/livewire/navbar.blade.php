    ...
    <nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
        <div class="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap">Belajar Livewire</span>
            </a>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="/"
                            class="block py-2 px-3 {{ $currentRoute == '/'
                            ...
                            aria-current="{{ $currentRoute == 'home' ? 'page' : false }}">Home</a>
                    </li>
                    <li>
                        <a href="/users"
                            class="block py-2 px-3 {{ $currentRoute == 'users'
                                ? 'text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0'
                                : 'text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0' }}"
                            aria-current="{{ $currentRoute == 'users' ? 'page' : false }}">
                            Users
                        </a>
                    </li>
                    <li>
                        <a href="about"
                            class="block py-2 px-3 {{ $currentRoute == 'about'
                                ? 'text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0'
                                : 'text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0' }}"
